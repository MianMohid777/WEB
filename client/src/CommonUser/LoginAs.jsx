    ...
    return (
        ...
        <div style={{}}>
            <ButtonGroup
                ...
                variant="contained"
            >
                <Button sx={{ marginTop: "3%", marginBottom: "3%", height: "100%", fontSize: "18px", width: "100%" }} endIcon={<ArrowForwardIcon sx={{ width: "30px" }} />}>
                    Login as Tourist
                </Button>
                <Button sx={{ marginTop: "3%", marginBottom: "3%", height: "100%", fontSize: "18px", width: "100%" }} endIcon={<ArrowForwardIcon />}>
            ...
            <Typography>
                ...
                <Grid container sx={{
                    ...
                    <Grid container item xs={12} sm={6} alignItems={"center"} direction={"column"} justifyContent={"space-between"}
                        ...
                        <Grid container justify="center" sx={{
                            display: "flex",
                            flexDirection: "column",
                            alignItems: "center",
                            maxWidth: "100%",
