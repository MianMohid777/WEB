                    ...
                    >
                        {informationBlock && (
                            ...
                            >
                                ...
                                >
                                    <p style={{color: '#00004d', fontSize: '30px', fontWeight: 'bold', margin: '5px 40px 0 0', display: 'inline-block'}}>Switzerland</p>
                                    <p style={{color: '#FFA500', fontSize: '30px', margin: '5px 15px 0 0', display: 'inline-block'}}>$ 1000</p>
                                    <p style={{color: '#808080', fontSize: '30px', margin: '5px 0 0 0', display: 'inline-block'}}>/ Couple</p>
                                </Box>
                                <Box
                                    sx={{
                                        marginTop: '10px',
                                ...
                                <Box
                                    sx={{}}
                                >
                                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Vel dolorem iure omnis aliquam rerum cumque, officia molestias sed, necessitatibus culpa ipsa! Iure voluptatum modi ipsa doloribus odit qui nihil quaerat?</p>
                                </Box>
                                <Box
                                    sx={{
                                        display: 'flex',
                                ...
                                >
                                    ...
                                    <Box
                                        sx={{width: '60%'}}
                                    >
                                        <p style={{fontSize: '18px', marginTop: '15px',}}>:Zurich, Switzerland</p>
                                    </Box>
                                </Box>
                                <Box
                                    sx={{
                                ...
                                >
                                    <Box
                                        sx={{width: '40%'}}
                                    >
                                        <p style={{color: '#FFA500', fontSize: '20px', marginTop: '15px', fontWeight: 'bold'}}>Departure</p>
                                    </Box>
                                    <Box
                                        sx={{width: '60%'}}
                                    >
                                ...
                                >
                                    <Box
                                        sx={{width: '40%'}}
                                    >
                                        <p style={{color: '#FFA500', fontSize: '20px', marginTop: '15px', fontWeight: 'bold'}}>Dress Code</p>
                                    </Box>
                                    <Box
                                        sx={{width: '60%'}}
                                    >
                                ...
                                >
                                    <Box>
                                        ...
                                        >
                                            ...
                                            >
                                                <p style={{color: '#00004d', fontSize: '25px', fontWeight: 'bold', margin: '0 0 0 0'}}>Day 1: Departure</p>
                                            </Box>
                                        </Box>
                                        <Box
                                            sx={{
